...
import { printCabinetLabel } from '@/app/lib/actions';
  ...
  return (
    <form action={formAction}>
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        {/* Cabinet Name */}
        <div className="mb-4">
          <label htmlFor="Cabinet Label" className="mb-2 block text-sm font-medium">
            Cabinet Label
          </label>
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                name="cabinetLabel"
                type="string"
                placeholder="Enter Cabinet Label"
                required
                minLength={6}
      ...
      <div className="mt-6 flex justify-end gap-4">
        ...
        <Button type="submit" aria-disabled={isPending} >Print Cabinet Label</Button>
      </div>
    </form >
  );
}
