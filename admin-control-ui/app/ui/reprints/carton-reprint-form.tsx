'use client';
import { printCartonLabel } from '@/app/lib/actions';
  ...
  return (
    <form action={formAction}>
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        {/* Carton Label */}
        <div className="mb-4">
          <label htmlFor="Carton Label" className="mb-2 block text-sm font-medium">
            Carton Label
          </label>
      ...
      <div className="mt-6 flex justify-end gap-4">
        ...
        <Button type="submit" aria-disabled={isPending}>Print Carton Label</Button>
      </div>
    </form>
  );
}
