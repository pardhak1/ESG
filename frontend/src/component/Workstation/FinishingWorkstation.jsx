...
const FinishingWorkstation = () => {
  ...
  const getWorkstation = (wsId) => {
    ...
    navigate(`/FinishingTrayid?station=${wsIdString}`);
  }
  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      ...
      <div className='finishing_stations'>
        <h1>STATIONS</h1> <br />
        {workOrder.length > 0 ? (
          ...
          <p>No finishing stations available</p>
        )}
      </div>
    </Box>
  );
...
export default FinishingWorkstation;