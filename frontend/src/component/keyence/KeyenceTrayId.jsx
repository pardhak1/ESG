...
const KeyenceTrayId = () => {
  ...
  //  const filteredTrayIdData = trayId.filter((e) =>{
  //   if(e.wo_traylabel !== ""){
  // return true
  //   } } )
    ...
    <>
      ...
      <div
        ...
        <div>
          ...
          <TextField
            ...
            fullWidth
            size="medium"
            sx={{ mt: 2, mb: 2, "& .MuiInputBase-input": { fontSize: "1.2rem", py: 1.5 } }}
            placeholder="Scan or Enter Tray Label"
      ...
      >
        <Box sx={style}>
          ...
          <Button onClick={() => navigate("/keyence/scan")}>ok</Button>
          {/* <TextField
            placeholder="Enter Pin"
            fullWidth
            sx={{
