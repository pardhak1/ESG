    ...
    <div style={
      ...
      <div style={{
        ...
        <div style={{ marginLeft: '2%' }}>
          ...
          <div style={{ display: 'flex' }}>
            <div>
              <TextField id="lot-num" autoFocus label="Lot Number" variant="standard" onBlur={errorBlur} />
            </div>
            <div style={{ marginLeft: '10%' }}>
              <TextField id="upc" label="Lens UPC" variant="standard" onBlur={errorBlur} />
            </div>
            <div style={{ marginLeft: '16.8%' }}>
              <TextField id="unparsed-barcode" label="Unparsed Barcode" variant="standard" onBlur={errorBlur} />
            </div>
            <div style={{ marginLeft: '10%' }}>
              <TextField id="expiration-date" label="Expiration Date" variant="standard" onBlur={errorBlur}/>
            </div>
